...
- **[`actions/`]**: Contains Redux action creators related with the Online auction/bidding system flow
- **[`reducer/`]**: Contains Redux reducers related with the Online auction/bidding system flow
